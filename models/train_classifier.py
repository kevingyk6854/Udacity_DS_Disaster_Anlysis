...
def load_data(database_filepath):
    """
        ...
        return:
            ...
            y: target dataframe
            category_names: categorical variables' labels
    """
...
def tokenize(text):
    ...
    """
        ...
        return: 
            clean_tokens: a list of clean words in their roots form
    """
...
def build_model():
    ...
    """
        A modelling pipeline that includes text processing steps and 
            a classifier (random forest) used to do classification.

        return:
            model: a model generated
    """
...
def evaluate_model(model, X_test, Y_test, category_names):
    ...
    """
        ...
        args:
            ...
            category_names: a list of text category name
